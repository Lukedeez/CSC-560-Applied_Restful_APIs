...
exports.add = function (req, res) {
    ...
    player.rushingYds = req.body.rushingYds;
    player.tdsThrown = req.body.tdsThrown;
    player.sacks = req.body.sacks;
    player.sacked = req.body.sacked;
    player.fgsMade = req.body.fgsMade;
    player.fgsMissed = req.body.fgsMissed;
...
exports.update = async function (req, res) {
    try {
        ...
        if (playerUpdate != null) {
            playerUpdate.jerseyNum = req.body.jerseyNum;
            ...
            playerUpdate.rushingYds = req.body.rushingYds;
            playerUpdate.tdsThrown = req.body.tdsThrown;
            playerUpdate.sacks = req.body.sacks;
            playerUpdate.sacked = req.body.sacked;
            playerUpdate.fgsMade = req.body.fgsMade;
            playerUpdate.fgsMissed = req.body.fgsMissed;
            playerUpdate.catchesMade = req.body.catchesMade;
        //save and check errors
            const playerSave = await playerUpdate.save();
